...
#PRD = pd.read_excel('rusprice/PR2019_270921_to_PR2022_OLD.xlsx').set_index('Код')
PRD = pd.read_excel('rusprice/PR2019_270921_to_PR2022_v2_2023.xlsx').set_index('Код')
PRD.columns = ['OGR', 'GRUP', 'KVG', 'PO', 'Col', 'Cla', 'Pst', 'Carat', 'Pr2018',
       'Pr2019', 'Pr2022','Pr2022v1']
PRD[['Pr2018','Pr2019','Pr2022']] = PRD[['Pr2018','Pr2019','Pr2022']].astype('float64')
